...
private ImageView img;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addBtn.setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View view) {
               Toast.makeText(AddLessonActivity.this, "添加成功", Toast.LENGTH_LONG).show();
...
//                    Toast.makeText(AddLessonActivity.this, "请填写完整", Toast.LENGTH_SHORT).show();
//                }else {
//                    try {
...
//                }
    ...
    private void Add(String name,String gender,int age,String specialty,String info){
        ...
        RequestQueue requestQueue= Volley.newRequestQueue(AddLessonActivity.this);
        JsonObjectRequest jsonObjectRequest=new JsonObjectRequest(Request.Method.GET, url, jsonObject, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject jsonObject) {
                try {
                    ...
                    if(info1.equals("添加成功")){
                        ...
                        Toast.makeText(AddLessonActivity.this, "添加失败", Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onErrorResponse(VolleyError volleyError) {
                ...
                Toast.makeText(AddLessonActivity.this, "网络失败", Toast.LENGTH_SHORT).show();
            }
        });
