...
//                    Toast.makeText(ExerciseActivity.this, "请填写完整", Toast.LENGTH_SHORT).show();
//                }else {
//                    try {
...
//        });
    ...
    private void Add(String name,String img,String author,String info,String lianjie){
        ...
        RequestQueue requestQueue= Volley.newRequestQueue(ExerciseActivity.this);
        JsonObjectRequest jsonObjectRequest=new JsonObjectRequest(Request.Method.GET, url, jsonObject, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject jsonObject) {
                try {
                    ...
                    if(info1.equals("添加成功")){
                        Toast.makeText(ExerciseActivity.this, "添加成功", Toast.LENGTH_SHORT).show();
                    }else {
                        Toast.makeText(ExerciseActivity.this, "添加失败", Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onErrorResponse(VolleyError volleyError) {
                ...
                Toast.makeText(ExerciseActivity.this, "网络失败", Toast.LENGTH_SHORT).show();
            }
        });
