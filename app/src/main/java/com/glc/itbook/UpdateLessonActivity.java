...
public class UpdateLessonActivity extends AppCompatActivity {
   ...
   private BaseAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        change=findViewById(R.id.coach_change);
        delete=findViewById(R.id.coach_delete);
        change.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                setContentView(R.layout.activity_update_coach);
                change_confirm = findViewById(R.id.btn_Change);
                change_confirm.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Toast.makeText(UpdateLessonActivity.this, "修改成功！", Toast.LENGTH_SHORT).show();
                        setContentView(R.layout.activity_coach_list2);
                        text = findViewById(R.id.item_bookUser);
                        text.setText("时间：18:00-19:00");
                        delete=findViewById(R.id.coach_delete);
                        delete.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Toast.makeText(UpdateLessonActivity.this, "删除成功！", Toast.LENGTH_SHORT).show();
                                setContentView(R.layout.activity_coach_list3);
                            }
                        });
                    }
                });
...
//                    }
//                } else {
//                    Toast.makeText(UpdateLessonActivity.this, "当前第一页", Toast.LENGTH_SHORT).show();
//                }
//
//            }
//        });
...
//                    }
//                } else {
//                    Toast.makeText(UpdateLessonActivity.this, "到达尾页", Toast.LENGTH_SHORT).show();
//                }
//            }
//        });
//        //跳转页码
...
//                    }
//                } else {
//                    Toast.makeText(UpdateLessonActivity.this, "超过最大页数", Toast.LENGTH_SHORT).show();
//
//                }
//            }
//        });
...
//        RequestQueue requestQueue = Volley.newRequestQueue(UpdateLessonActivity.this);
...
//                        view = View.inflate(UpdateLessonActivity.this, R.layout.item_booklist2, null);
...
//                              Intent intent=new Intent(UpdateLessonActivity.this,UpdateItemActivity.class);
...
//                            }
//                        });
//                        Glide.with(UpdateLessonActivity.this).load(book.getItems().get(i).getBook_img()).into(imageView);
//
//                        return view;
//                    }
//                };
...
//                Toast.makeText(UpdateLessonActivity.this, "网络出错", Toast.LENGTH_SHORT).show();
//            }
//        });
            ...
            public void onResponse(JSONObject jsonObject) {
                try {
                    ...
                    if(info.equals("删除成功")){
                        ...
                        Toast.makeText(UpdateLessonActivity.this, "删除失败", Toast.LENGTH_SHORT).show();
                    }
